...
New tool/family ranked first by mean F1 in 6 of 6 new-tool benchmarks with available F1.
Using F1 where available and recall otherwise, the new tool/family ranked first in 8 of 8 new-tool benchmarks.
New tool/family had higher mean F1 than the average of comparator tools in 6 of 6 benchmarks with available F1.
...
| 2 | Uhrig 2021 | Arriba | Arriba | Recall_Sensitivity 1/7 | Arriba | nan | nan | NA |
| 4 | Balan 2021 | SeekFusion | SeekFusion | Recall_Sensitivity 1/4 | SeekFusion | nan | nan | NA |
| 5 | Zhao 2017 | GFusion | GFusion | F1 1/5 | GFusion | 0.550 | 0.398 | 2/3 |
...
## Notes
- Benchmark 2: recall only (Arriba)
